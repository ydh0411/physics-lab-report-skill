...
\else
  ...
  \IfFontExistsTF{Times New Roman}{%
    ...
    \newfontfamily\tablefont{TeX Gyre Termes}
    \newfontfamily\titlefont{TeX Gyre Termes}
    \newfontfamily\watermarkfont{TeX Gyre Termes}
  }
  ...
  \IfFileExists{newtxmath.sty}{\usepackage{newtxmath}}{%
    \PackageWarningNoLine{postlab}{newtxmath.sty not found; using the default math font}}
\fi
\usepackage{amsmath}
